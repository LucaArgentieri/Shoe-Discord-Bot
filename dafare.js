...
//                     name: "StadiumGoods:",
//                     value: `${
//                       prossimo.lowestResellPrice.stadiumGoods === undefined
//                         ? (prossimo.lowestResellPrice.stadiumGoods = "N/A")
//                         : prossimo.lowestResellPrice.stadiumGoods + "$"
//                     }`,
//                     inline: true,
//                   }
//                 )
...
//         try {
//           msg.channel.send(
//             "Ecco a te le scarpe più popolari degli ultimi 3 mesi"
//           );
...
//               if (
//                 (y >= qstanno && m == qstmese) ||
//                 (y >= qstanno && m == qstmese - 1) ||
//                 (y >= qstanno && m == qstmese - 2)
//               ) {
//                 let info = embed
...
//                       name: "Prezzo retail:",
//                       value: `${
//                         stonks.retailPrice === undefined
//                           ? (stonks.retailPrice = "N/A")
//                           : stonks.retailPrice + "$"
//                       }`,
//                     },
//                     {
...
//                       name: "StockX:",
//                       value: `${
//                         stonks.lowestResellPrice.stockX === undefined
//                           ? (stonks.lowestResellPrice.stockX = "N/A")
//                           : stonks.lowestResellPrice.stockX + "$"
//                       }`,
//                       inline: true,
//                     },
//                     {
//                       name: "FlightClub:",
//                       value: `${
//                         stonks.lowestResellPrice.flightClub === undefined
//                           ? (stonks.lowestResellPrice.flightClub = "N/A")
//                           : stonks.lowestResellPrice.flightClub + "$"
//                       }`,
//                       inline: true,
//                     },
//                     {
//                       name: "Goat:",
//                       value: `${
//                         stonks.lowestResellPrice.goat === undefined
//                           ? (stonks.lowestResellPrice.goat = "N/A")
//                           : stonks.lowestResellPrice.goat + "$"
//                       }`,
//                       inline: true,
//                     },
//                     {
//                       name: "StadiumGoods:",
//                       value: `${
//                         stonks.lowestResellPrice.stadiumGoods === undefined
//                           ? stonks.lowestResellPrice.stadiumGoods + "N/A"
//                           : stonks.lowestResellPrice.stadiumGoods + "$"
//                       }`,
//                       inline: true,
//                     }
//                   )
//                   .setDescription(
//                     `Data Release: ${moment(stonks.releaseDate).format("LL")}`
//                   );
